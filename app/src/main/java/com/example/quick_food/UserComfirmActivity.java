...
import com.example.quick_food.GetterSetters.UserHistoryDetails;
                ...
                if (finalHistoryObj == null || !finalHistoryObj.getHelmetCkeckOut().equals("-")) {
                    ...
                    db.collection("HelmetHistory").document(docPath).set(get_data)
                            ...
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    Intent intent = new Intent(UserComfirmActivity.this, FoodCategory.class);
                    ...
                    db.collection("HelmetHistory").document(docPath).update(get_data)
                            ...
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    //progressDialog.dismiss();
                                    Intent intent = new Intent(UserComfirmActivity.this, Foods.class);
                                    startActivity(intent);
                                    finish();
